...
//
//     final pestRecommendationData = pestRecommendationDataFromJson(jsonString);

import 'dart:convert';

PestRecommendationData pestRecommendationDataFromJson(String str) => PestRecommendationData.fromJson(json.decode(str));

String pestRecommendationDataToJson(PestRecommendationData data) => json.encode(data.toJson());

class PestRecommendationData {
    int? id;
    String ?code;
    String? diseaseimage;
    Crop ?crop;
    ...
    factory PestRecommendationData.fromJson(Map<String, dynamic> json) => PestRecommendationData(
        id: json["id"],
        code: json["code"],
